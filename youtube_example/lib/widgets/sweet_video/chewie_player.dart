...
class ChewieController extends ChangeNotifier {
  ...
  //   // TODO: implement ==
  //   return other is ChewieController &&
  //       other._isFullScreen == _isFullScreen &&
  //       other._showControls == _showControls;
  // }
  ...
  // void showControllerTest(bool show) {
  //   print("vao trong nay _showControls  " + _showControls.toString());
  //   print("vao trong nay show " + show.toString());
  ...
  // int get hashCode => _isFullScreen.hashCode + _showControls.hashCode;
