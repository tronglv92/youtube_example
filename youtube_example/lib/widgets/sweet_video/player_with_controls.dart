...
class PlayerWithControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildControls(
      ...
      final bool showControls=chewieController.showControls;
      print("PlayerWithControls build showControls "+showControls.toString());
    ...
    Stack _buildPlayerWithControls(
      ...
      return Stack(
        children: <Widget>[
          ...
          Center(
            child: chewieController.videoPlayerController!=null? AspectRatio(
